...
export const grammarTablesContent = {
  ...
  subtitle: l(
    'Семь опорных схем: коротко, точно и с формами, которые используются в Испании.',
    'Seven essential references: concise, accurate and complete with the forms used in Spain.',
  ),
