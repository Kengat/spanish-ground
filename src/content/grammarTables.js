...
export const grammarTablesContent = {
  ...
  subtitle: l(
    'Восемь опорных схем: коротко, точно и с формами, которые используются в Испании.',
    'Eight essential references: concise, accurate and complete with the forms used in Spain.',
  ),
