...
export const grammarTablesContent = {
  ...
  subtitle: l(
    'Пять опорных схем: коротко, точно и с формами, которые используются в Испании.',
    'Five essential references: concise, accurate and complete with the forms used in Spain.',
  ),
